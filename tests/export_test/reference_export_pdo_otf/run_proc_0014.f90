...
subroutine run_proc_CO_oxi_bridge_bridge_r(cell)
...
! Disable processes
    ...
    if(can_do(CO_oxi_bridge_bridge_l,cell + (/ 2, 0, 0, 1/))) then
        call del_proc(CO_oxi_bridge_bridge_l,cell + (/ 2, 0, 0, 1/))
    end if
...
! Enable processes
    ...
    case(CO)
        call add_proc(CO_diff_bridge_bridge_l, cell + (/ 2, 0, 0, 1/), gr_CO_diff_bridge_bridge_l(cell + (/ 2, 0, 0, 0/)))
    case(O)
        call add_proc(O_diff_bridge_bridge_l, cell + (/ 2, 0, 0, 1/), gr_O_diff_bridge_bridge_l(cell + (/ 2, 0, 0, 0/)))
    case(empty)
...
end subroutine run_proc_CO_oxi_bridge_bridge_r
