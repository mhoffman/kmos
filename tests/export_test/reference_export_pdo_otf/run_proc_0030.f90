...
subroutine run_proc_O_diff_bridge_bridge_r(cell)
...
! Enable processes
    ...
    case(CO)
        call add_proc(CO_oxi_bridge_bridge_r, cell + (/ 1, 0, 0, 1/), gr_CO_oxi_bridge_bridge_r(cell + (/ 1, 0, 0, 0/)))
    case(empty)
        call add_proc(O_diff_bridge_bridge_r, cell + (/ 1, 0, 0, 1/), gr_O_diff_bridge_bridge_r(cell + (/ 1, 0, 0, 0/)))
    case(O)
        call add_proc(O2_des_bridge_bridge_r, cell + (/ 1, 0, 0, 1/), gr_O2_des_bridge_bridge_r(cell + (/ 1, 0, 0, 0/)))
    end select
...
end subroutine run_proc_O_diff_bridge_bridge_r
