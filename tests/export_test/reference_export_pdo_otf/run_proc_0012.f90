...
subroutine run_proc_CO_diff_hollow_hollow_r(cell)
...
! Enable processes
    ...
    case(O)
        call add_proc(CO_oxi_bridge_hollow_l, cell + (/ 2, 0, 0, 1/), gr_CO_oxi_bridge_hollow_l(cell + (/ 2, 0, 0, 0/)))
    case(empty)
    ...
    case(O)
        call add_proc(CO_oxi_hollow_hollow_l, cell + (/ 2, 0, 0, 1/), gr_CO_oxi_hollow_hollow_l(cell + (/ 2, 0, 0, 0/)))
    case(empty)
        call add_proc(CO_diff_hollow_hollow_r, cell + (/ 1, 0, 0, 1/), gr_CO_diff_hollow_hollow_r(cell + (/ 1, 0, 0, 0/)))
    end select


end subroutine run_proc_CO_diff_hollow_hollow_r
