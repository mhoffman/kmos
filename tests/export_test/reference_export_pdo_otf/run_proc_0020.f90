...
subroutine run_proc_CO_oxi_hollow_hollow_r(cell)
...
! Enable processes
    ...
    case(CO)
        call add_proc(CO_diff_bridge_hollow_l, cell + (/ 2, 0, 0, 1/), gr_CO_diff_bridge_hollow_l(cell + (/ 2, 0, 0, 0/)))
    case(O)
        call add_proc(O_diff_bridge_hollow_l, cell + (/ 2, 0, 0, 1/), gr_O_diff_bridge_hollow_l(cell + (/ 2, 0, 0, 0/)))
    case(empty)
    ...
    case(CO)
        call add_proc(CO_diff_hollow_hollow_l, cell + (/ 2, 0, 0, 1/), gr_CO_diff_hollow_hollow_l(cell + (/ 2, 0, 0, 0/)))
    case(O)
        call add_proc(O_diff_hollow_hollow_l, cell + (/ 2, 0, 0, 1/), gr_O_diff_hollow_hollow_l(cell + (/ 2, 0, 0, 0/)))
    case(empty)
...
end subroutine run_proc_CO_oxi_hollow_hollow_r
