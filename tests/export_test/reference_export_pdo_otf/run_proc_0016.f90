...
subroutine run_proc_CO_oxi_bridge_hollow_l(cell)
...
! Update the lattice
    ...
    call replace_species(cell + (/-1, 0, 0, pdo_hollow/),CO,empty)
...
! Enable processes
    ...
    call add_proc(CO_ads_hollow, cell + (/ -1, 0, 0, 1/), gr_CO_ads_hollow(cell + (/ -1, 0, 0, 0/)))
    ...
    case(CO)
        call add_proc(CO_diff_hollow_hollow_r, cell + (/ -2, 0, 0, 1/), gr_CO_diff_hollow_hollow_r(cell + (/ -2, 0, 0, 0/)))
    case(O)
        call add_proc(O_diff_hollow_hollow_r, cell + (/ -2, 0, 0, 1/), gr_O_diff_hollow_hollow_r(cell + (/ -2, 0, 0, 0/)))
    case(empty)
        call add_proc(O2_ads_hollow_hollow, cell + (/ -2, 0, 0, 1/), gr_O2_ads_hollow_hollow(cell + (/ -2, 0, 0, 0/)))
    end select


end subroutine run_proc_CO_oxi_bridge_hollow_l
