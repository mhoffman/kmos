...
subroutine run_proc_CO_diff_bridge_bridge_l(cell)
...
! Update the lattice
    call replace_species(cell + (/0, 0, 0, pdo_bridge/),CO,empty)
...
! Enable processes
    ...
    case(O)
        call add_proc(CO_oxi_bridge_bridge_r, cell + (/ -2, 0, 0, 1/), gr_CO_oxi_bridge_bridge_r(cell + (/ -2, 0, 0, 0/)))
    case(empty)
        call add_proc(CO_diff_bridge_bridge_l, cell + (/ -1, 0, 0, 1/), gr_CO_diff_bridge_bridge_l(cell + (/ -1, 0, 0, 0/)))
    end select
    ...
    case(O)
        call add_proc(CO_oxi_hollow_bridge_r, cell + (/ -2, 0, 0, 1/), gr_CO_oxi_hollow_bridge_r(cell + (/ -2, 0, 0, 0/)))
    case(empty)
        call add_proc(CO_diff_bridge_hollow_l, cell + (/ -1, 0, 0, 1/), gr_CO_diff_bridge_hollow_l(cell + (/ -1, 0, 0, 0/)))
    end select


end subroutine run_proc_CO_diff_bridge_bridge_l
